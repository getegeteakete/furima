        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-xl font-black text-white">フリマライブ</p>
                <p className="text-xs text-gray-400">Furima LIVE</p>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-6">
              {['X', 'IG', 'FB', 'LINE'].map((sns) => (
                <a key={sns} href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-orange-500 flex items-center justify-center text-xs font-bold transition-all">
                  {sns}
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-400 hover:text-orange-400 transition-colors">よくある質問</a></li>
              <li><a href="#" className="text-sm text-gray-400 hover:text-orange-400 transition-colors">お問い合わせ</a></li>
              <li><a href="#" className="text-sm text-gray-400 hover:text-orange-400 transition-colors">利用規約</a></li>
              <li><a href="#" className="text-sm text-gray-400 hover:text-orange-400 transition-colors">プライバシーポリシー</a></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-500">© 2026 フリマライブ. All rights reserved.</p>
          <p className="text-xs text-gray-500">運営: 株式会社フリマライブ</p>
        </div>
      </div>
    </footer>
  );
