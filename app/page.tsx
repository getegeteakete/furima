        ...
        <div className="relative section-spacing">
          <div className="container-main">
            <div className="grid grid-cols-12 gap-6 lg:gap-12 items-center">
              {/* Hero Text - 6/12 columns */}
              <div className="col-span-12 lg:col-span-6 text-center lg:text-left py-6 lg:py-8">
                <p className="text-xs sm:text-sm lg:text-base font-bold text-orange-500 mb-3 lg:mb-4 tracking-widest uppercase">
                  全国対応・誰でも始められる
                </p>
                <h1 className="text-3xl sm:text-4xl lg:text-6xl font-black leading-tight lg:leading-[1.1] mb-6 lg:mb-8">
                ...
                <p className="text-sm sm:text-base lg:text-lg text-gray-600 mb-8 lg:mb-10 leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-8 lg:mb-10">
                  <Link
                    href="/events"
                    className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full font-bold text-sm lg:text-base shadow-lg hover:shadow-xl hover:scale-105 transition-all"
                  >
                    イベントを見る <span>→</span>
                  </Link>
                  <Link
                    href="/seller"
                    className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-orange-600 border-2 border-orange-500 rounded-full font-bold text-sm lg:text-base hover:bg-orange-50 transition-all"
                  >
                    出店してみる
                  </Link>
                </div>
              ...
              {/* Phone Mockup - 6/12 columns */}
              <div className="col-span-12 lg:col-span-6 flex justify-center items-center min-h-[360px] lg:min-h-[600px]">
        ...
        <div className="relative section-spacing">
          <div className="container-main">
            ...
            <div className="text-center mb-12 lg:mb-16">
              ...
              <p className="text-base lg:text-lg font-medium mb-2 text-orange-100">見るだけでも楽しい！</p>
            ...
            <div className="grid grid-cols-12 gap-6 lg:gap-8 mb-12 lg:mb-16">
              {[
                ...
                <div key={idx} className="col-span-12 sm:col-span-6 lg:col-span-4">
                  <Link
                    href="/live"
                    className="block bg-white/10 backdrop-blur border border-white/20 rounded-3xl p-6 lg:p-8 text-left hover:bg-white/20 hover:scale-105 transition-all h-full"
                  >
                    ...
                    <p className="text-sm opacity-80 mb-2">📍 {event.region}</p>
            ...
            <div className="text-center">
              <Link
                href="/events"
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-orange-600 rounded-full font-bold text-sm lg:text-base shadow-xl hover:shadow-2xl hover:scale-105 transition-all"
              >
                すべてのイベントを見る →
              </Link>
            </div>
      ...
      <section className="relative bg-orange-600 text-white overflow-hidden">
        <div className="relative section-spacing">
          <div className="container-main text-center">
            ...
            {/* Grid: 10 items */}
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-8 max-w-5xl mx-auto">
              {[
                { emoji: '👗', label: '女性服' },
                { emoji: '🧥', label: '男性服' },
                { emoji: '💄', label: '化粧品' },
                ...
                <div key={item.label} className="group">
                  <div className="aspect-square bg-white rounded-full flex items-center justify-center text-4xl lg:text-5xl mb-3 lg:mb-4 shadow-lg group-hover:scale-110 transition-transform cursor-pointer">
                    {item.emoji}
                  </div>
                  <p className="text-xs lg:text-sm font-bold text-white/90">{item.label}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="container-main">
            <div className="grid grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="col-span-12 lg:col-span-6 text-center lg:text-left py-4 lg:py-0">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-6xl font-black leading-tight mb-6 lg:mb-8">
                  年間<br className="hidden sm:block" />
                  <span className="block text-5xl sm:text-6xl lg:text-7xl my-2">10,000</span>
                  件以上のイベント開催！
                </h2>
                <p className="text-xs sm:text-base leading-relaxed text-white/90 mb-8 lg:mb-10">
          ...
          <div className="container-main">
            ...
            <div className="grid grid-cols-12 gap-6 lg:gap-8">
              {[
                ...
                <div key={idx} className="col-span-12 sm:col-span-6 lg:col-span-4">
                  <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all h-full flex flex-col">
                    ...
                    <h3 className="text-base sm:text-lg lg:text-xl font-black text-gray-900 mb-4 lg:mb-6 whitespace-pre-line leading-snug">
                      {point.title}
                    </h3>

                    <div className="bg-orange-50 rounded-2xl p-5 lg:p-6 mb-4 lg:mb-6 text-center flex-shrink-0">
                      <p className="text-xs lg:text-sm text-orange-700 font-bold mb-1.5">{point.badge}</p>
                      <p className="text-3xl sm:text-4xl lg:text-5xl font-black text-orange-600 mb-1.5">{point.value}</p>
            ...
            <div className="grid grid-cols-12 gap-8 lg:gap-12">
              {[
                ...
                <div key={item.step} className="col-span-12 sm:col-span-6 lg:col-span-4 text-center">
                  <div className="relative w-28 h-28 lg:w-32 lg:h-32 mx-auto mb-6 lg:mb-8">
                    <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center text-5xl lg:text-6xl shadow-lg">
                      {item.icon}
                    </div>
                  ...
                  <h3 className="text-lg lg:text-xl font-black text-gray-900 mb-4 lg:mb-5">{item.title}</h3>
      ...
      <section className="relative bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 text-white overflow-hidden">
        ...
        <div className="relative section-spacing">
          <div className="container-main text-center max-w-2xl mx-auto">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-6 lg:mb-8 leading-tight">
              さあ、はじめよう！<br />
              あなたのフリマライフ
            </h2>
            <p className="text-sm lg:text-base mb-10 lg:mb-12 leading-relaxed text-orange-50">
              会員登録は無料！全国の出店者と購入者をつなぐ、新しいフリマ体験。
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center gap-2 px-8 lg:px-12 py-4 bg-white text-orange-600 rounded-full font-bold text-sm lg:text-base shadow-xl hover:scale-105 transition-all"
              >
                無料で会員登録 →
              </Link>
              <Link
                href="/events"
                className="inline-flex items-center justify-center gap-2 px-8 lg:px-12 py-4 bg-orange-700/50 backdrop-blur text-white border-2 border-white/30 rounded-full font-bold text-sm lg:text-base hover:bg-orange-700 transition-all"
              >
                イベントを見る
              </Link>
            </div>
...
function PhoneMockup({ variant = 'home' }: { variant?: 'home' | 'live' }) {
  return (
    <div className="relative animate-float">
      <div className="relative w-56 sm:w-64 lg:w-80 h-[460px] sm:h-[540px] lg:h-[650px] bg-gray-900 rounded-3xl lg:rounded-4xl p-3 lg:p-4 shadow-2xl">
      ...
      {variant === 'home' && (
        <>
          <div className="absolute -left-8 lg:-left-16 top-16 bg-white rounded-2xl rounded-bl-sm shadow-xl px-3 lg:px-4 py-2 lg:py-3 max-w-[140px] animate-bounce-soft">
            <p className="text-[9px] lg:text-xs font-bold text-orange-600 mb-0.5">nana♡</p>
            <p className="text-[8px] lg:text-xs text-gray-700">欲しい！</p>
          </div>
          <div className="absolute -right-6 lg:-right-12 top-40 bg-orange-500 text-white rounded-2xl rounded-br-sm shadow-xl px-3 lg:px-4 py-2 lg:py-3 max-w-[130px] animate-bounce-soft" style={{ animationDelay: '0.5s' }}>
            <p className="text-[9px] lg:text-xs font-bold mb-0.5">moru</p>
            <p className="text-[8px] lg:text-xs">セール？</p>
          </div>
          <div className="absolute -left-10 lg:-left-16 bottom-32 bg-white rounded-2xl rounded-bl-sm shadow-xl px-3 lg:px-4 py-2 lg:py-3 max-w-[130px] animate-bounce-soft" style={{ animationDelay: '1s' }}>
            <p className="text-[9px] lg:text-xs font-bold text-orange-600 mb-0.5">parumu</p>
            <p className="text-[8px] lg:text-xs text-gray-700">可愛い！</p>
          </div>
        </>
      )}
    </div>
...
function PhoneHomeContent() {
  return (
    <>
      <div className="bg-orange-500 px-3 lg:px-4 pt-7 lg:pt-8 pb-2 lg:pb-2.5 flex items-center justify-between">
      ...
      <div className="flex-1 bg-gradient-to-b from-orange-50 to-white p-2.5 lg:p-3 overflow-hidden space-y-2">
        <div className="bg-white rounded-xl lg:rounded-2xl p-2.5 lg:p-3 shadow-sm border border-orange-100">
...
function PhoneLiveContent() {
  return (
    <>
      <div className="bg-gray-900 text-white px-3 lg:px-4 pt-7 lg:pt-8 pb-1.5 flex items-center justify-between">
